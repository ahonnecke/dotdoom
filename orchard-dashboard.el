...
(declare-function orchard-dispatch "config-orchard")
(declare-function orchard-new-feature "config-orchard")
(declare-function orchard-new-bugfix "config-orchard")
(declare-function orchard-new-chore "config-orchard")
(declare-function orchard-new-refactor "config-orchard")
(declare-function orchard-new-docs "config-orchard")
(declare-function orchard-new-experiment "config-orchard")
(declare-function orchard-open-at-point "config-orchard")
(declare-function orchard-claude-at-point "config-orchard")
(declare-function orchard-magit-at-point "config-orchard")
(declare-function orchard-dired-at-point "config-orchard")
(declare-function orchard-test-at-point "config-orchard")
(declare-function orchard-issue-start "config-orchard")
(declare-function orchard-issue-browse "config-orchard")
(declare-function orchard-find-issue "config-orchard")
(declare-function orchard-resolve-issue "config-orchard")
(declare-function orchard-next-step "config-orchard")
(declare-function orchard-push-at-point "config-orchard")
(declare-function orchard-pr-at-point "config-orchard")
(declare-function orchard-hide-at-point "config-orchard")
(declare-function orchard-show-hidden "config-orchard")
(declare-function orchard-archive-at-point "config-orchard")
(declare-function orchard-delete-at-point "config-orchard")
(declare-function orchard-allocate-port "config-orchard")
(declare-function orchard-release-port "config-orchard")
(declare-function orchard-cleanup "config-orchard")
(declare-function orchard-cleanup-dry-run "config-orchard")
(declare-function orchard-cleanup-merged "config-orchard")
(declare-function orchard-cleanup-merged-dry-run "config-orchard")
(declare-function orchard-quit-all "config-orchard")
(declare-function orchard-toggle-window-dedication "config-orchard")
(declare-function orchard--get-archivable-worktrees "config-orchard")

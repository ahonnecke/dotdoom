;;; ../src/home/.doom.d/init-ejira.el -*- lexical-binding: t; -*-
...
(setq jiralib2-url             "https://cirrusv2x.atlassian.net"
      jiralib2-auth            'token             ;; 'cookie, 'token or 'basic
      jiralib2-user-login-name "ashton.honnecke@us.panasonic.com"  ;; email for JIRA Cloud
      jiralib2-token            "txOHKgLUFMf3A4Q4PJe5B6E2")              ;; for token auth with JIRA Cloud
